...
Pixel `1.0.2` 重设计代码面板，新增语言铭牌并修复浮动滚动条遮挡：

| 版本 | 主要变化 |
| --- | --- |
| [`1.0.2`](docs/releases/1.0.2.md) | 新增语言铭牌，修复滚动条遮挡代码，并改善编辑与 PDF 的代码可读性。 |
...
| 项目 | 当前信息 |
| --- | --- |
| 当前版本 | <code><!-- pixel-version:start -->1.0.2<!-- pixel-version:end --></code> |
