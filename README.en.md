...
The theme embeds Fusion Pixel for identity headings and JetBrains Mono for code and technical status. Body text uses a system font stack with operating-system fallback for uncommon characters.
...
Pixel is released under the [MIT License](LICENSE). Embedded Fusion Pixel and JetBrains Mono files retain their SIL Open Font License 1.1 terms; sources, checksums, and licenses are available under [`src/assets/fonts/`](src/assets/fonts/).
